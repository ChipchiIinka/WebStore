...
//        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
//                .body("Illegal State. Contact the administrator.");
//    }
//
...
//                .body("Access Denied. You don't have access.");
//    }
//
...
//                .body("Bad Request. Check that the data entered is correct.");
//    }
//
...
//        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
//                .body("Illegal Argument. Check that the data entered is correct.");
//    }
//
...
//                .body("Not Found. Check that the data entered is correct.");
//    }
//
